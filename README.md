...
```bash
claude --plugin-dir ./prawo-pl-eli-v1.2.1.zip
# albo zdalnie, bez pobierania:
claude --plugin-url https://github.com/jamarpl21/prawo-pl-eli/releases/download/v1.2.1/prawo-pl-eli-v1.2.1.zip
```
...
Wersja pluginu (obecnie **1.2.1**) jest zadeklarowana w sześciu miejscach i musi być wszędzie identyczna —
