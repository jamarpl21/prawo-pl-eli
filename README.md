...
```bash
claude --plugin-dir ./prawo-pl-saos-v1.6.5.zip
# albo zdalnie, bez pobierania:
claude --plugin-url https://github.com/jamarpl21/prawo-pl-eli/releases/download/v1.6.5/prawo-pl-saos-v1.6.5.zip
```
...
Wszystkie pluginy są wersjonowane **razem (lockstep)** — jedna wersja (obecnie **1.6.5**) zadeklarowana
